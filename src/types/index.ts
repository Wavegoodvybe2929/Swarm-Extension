...
export class TaskError extends SwarmError {
  constructor(
    message: string,
...
export interface HiveMemoryBank {
  ...
  checkHealth(): Promise<{ healthy: boolean; issues: string[] }>;
  dispose(): void;
}

// Specification generation types
...
// Hive orchestration result types
