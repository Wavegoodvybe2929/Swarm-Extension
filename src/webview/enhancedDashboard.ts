...
export class EnhancedDashboard implements vscode.Disposable {
    ...
    private async spawnAgentFromDashboard(type: string, name?: string): Promise<void> {
        try {
