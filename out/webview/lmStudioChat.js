...
class LMStudioChat {
    ...
    async showChat() {
        try {
            ...
            this.chatPanel = vscode.window.createWebviewPanel('lmStudioChat', '🤖 LM Studio Chat', vscode.ViewColumn.Two, {
                enableScripts: true,
    ...
    async sendToLMStudio(userMessage) {
...
Use these tools when appropriate to provide comprehensive assistance.`;
    ...
    async simulateLMStudioResponse(systemPrompt, history, userMessage) {
...
exports.LMStudioChat = LMStudioChat;
//# sourceMappingURL=lmStudioChat.js.map